...
#define unshield_trace(format, ...) 
//	Unshield_log(UNSHIELD_LOG_LEVEL_TRACE,__PRETTY_FUNCTION__, __LINE__, format, __VA_ARGS__)

#define unshield_warning(format, ...) 
//	Unshield_log(UNSHIELD_LOG_LEVEL_WARNING,__PRETTY_FUNCTION__, __LINE__, format, __VA_ARGS__)
...
#define unshield_error(format, ...) 
//	Unshield_log(UNSHIELD_LOG_LEVEL_ERROR,__PRETTY_FUNCTION__, __LINE__, format, __VA_ARGS__)
